...
import { CoachingStaffMember } from "@/utils/coachingStaffUtils";
import PlayerImageResizer from "./PlayerImageResizer";

interface CoachingStaffFormProps {
  isEditing: boolean;
...
const CoachingStaffForm = ({ isEditing, onSubmit, onCancel, initialValues }: CoachingStaffFormProps) => {
