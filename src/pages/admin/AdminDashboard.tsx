      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="bg-gray-900 border-gray-800 text-white">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <HelpCircle className="h-5 w-5 text-german-gold" />
                FAQ Management
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-400 mb-4">Manage frequently asked questions and answers.</p>
              <Link to="/admin/faqs">
                <Button className="w-full bg-german-red hover:bg-german-gold">Manage FAQs</Button>
              </Link>
            </CardContent>
          </Card>
