                ...
                <Card className="bg-black border-german-red hover:border-german-gold transition-colors duration-300">
                  <CardHeader className="flex flex-col items-center">
                    <div className="flex items-center justify-center w-full mb-4 space-x-8">
                      ...
                      <div className={`${player.name === "Marcél Schlicht" ? "w-32 h-32" : player.name === "Malte Rohrmoser" ? "w-56 h-56" : player.name === "Jay Kay" ? "w-56 h-56" : player.name === "Zak Bredin" ? "w-36 h-36" : "w-24 h-24"} flex items-center justify-center`}>
                        {player.image ? (
                          <img 
                            src={player.image}
                            alt={player.name}
