...
import { fetchPublishedContent } from "@/utils/siteContentUtils";
...
const LotteryTerms = () => {
  ...
  useEffect(() => {
    const loadContent = async () => {
      try {
        const publishedContent = await fetchPublishedContent("lottery-terms");
        setContent(publishedContent);
      } catch (error) {
        console.error("Error loading lottery terms content:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="animate-pulse">Loading terms...</div>
      </div>
    );
  }
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">{getContent("page_title", "Terms & Conditions")}</h1>
            </div>
            <p className="text-xl text-gray-400">
              {getContent("page_subtitle", "German Exiles Rugby League Lottery – Legal Terms & Conditions")}
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            className="space-y-8"
          >
            {/* Section 1 - Lottery Structure */}
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                <CardTitle className="text-2xl text-white flex items-center gap-2">
                  <FileText className="w-6 h-6" />
                  {getContent("section_1_title", "1. Lottery Structure")}
                </CardTitle>
              </CardHeader>
              <CardContent className="text-gray-300 space-y-3">
                <div 
                  ...
                  dangerouslySetInnerHTML={{ 
                    __html: getContent("section_1_content", `
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                <CardTitle className="text-2xl text-white">
                  {getContent("section_2_title", "2. Number Selection")}
                </CardTitle>
              </CardHeader>
              <CardContent className="text-gray-300">
                <div 
                  className="prose prose-invert max-w-none"
                  dangerouslySetInnerHTML={{ 
                    __html: getContent("section_2_content", `
                      <ol class="list-decimal list-inside" start="6">
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                <CardTitle className="text-2xl text-white">
                  {getContent("section_3_title", "3. Draws")}
                </CardTitle>
              </CardHeader>
              <CardContent className="text-gray-300 space-y-3">
                <div 
                  className="prose prose-invert max-w-none"
                  dangerouslySetInnerHTML={{ 
                    __html: getContent("section_3_content", `
                      <ol class="list-decimal list-inside space-y-2" start="7">
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                <CardTitle className="text-2xl text-white">
                  {getContent("section_4_title", "4. Winners")}
                </CardTitle>
              </CardHeader>
              <CardContent className="text-gray-300 space-y-3">
                <div 
                  className="prose prose-invert max-w-none"
                  dangerouslySetInnerHTML={{ 
                    __html: getContent("section_4_content", `
                      <ol class="list-decimal list-inside space-y-2" start="12">
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                <CardTitle className="text-2xl text-white">
                  {getContent("section_5_title", "5. Eligibility")}
                </CardTitle>
              </CardHeader>
              <CardContent className="text-gray-300 space-y-3">
                <div 
                  className="prose prose-invert max-w-none"
                  dangerouslySetInnerHTML={{ 
                    __html: getContent("section_5_content", `
                      <ol class="list-decimal list-inside space-y-2" start="17">
            ...
            {/* Section 6 - Payments and Checkout */}
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                <CardTitle className="text-2xl text-white">
                  {getContent("section_6_title", "6. Payments and Checkout")}
                </CardTitle>
              </CardHeader>
              <CardContent className="text-gray-300 space-y-3">
                <div 
                  className="prose prose-invert max-w-none"
                  dangerouslySetInnerHTML={{ 
                    __html: getContent("section_6_content", `
                      <ol class="list-decimal list-inside space-y-2" start="19">
            ...
            {/* Section 7 - Prize Allocation */}
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                <CardTitle className="text-2xl text-white">
                  {getContent("section_7_title", "7. Prize Allocation")}
                </CardTitle>
              </CardHeader>
              <CardContent className="text-gray-300 space-y-3">
                <div 
                  className="prose prose-invert max-w-none"
                  dangerouslySetInnerHTML={{ 
                    __html: getContent("section_7_content", `
                      <ol class="list-decimal list-inside space-y-2" start="23">
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                <CardTitle className="text-2xl text-white">
                  {getContent("section_8_title", "8. General Rules")}
                </CardTitle>
              </CardHeader>
              <CardContent className="text-gray-300 space-y-3">
                <div 
                  className="prose prose-invert max-w-none"
                  dangerouslySetInnerHTML={{ 
                    __html: getContent("section_8_content", `
                      <ol class="list-decimal list-inside space-y-2" start="26">
